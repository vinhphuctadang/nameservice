...
export type NameserviceMsgBuyResponse = object;

export type NameserviceMsgChangeSaleStatusResponse = object;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   */
  queryInfo = (name: string, params: RequestParams = {}) =>
    this.request<NameserviceQueryInfoResponse, RpcStatus>({
      path: `/vinhphuctadang/nameservice/nameservice/info/${name}`,
      method: "GET",
      format: "json",
      ...params,
    });
  ...
  queryParams = (params: RequestParams = {}) =>
    this.request<NameserviceQueryParamsResponse, RpcStatus>({
      path: `/vinhphuctadang/nameservice/nameservice/params`,
      method: "GET",
      format: "json",
      ...params,
    });
